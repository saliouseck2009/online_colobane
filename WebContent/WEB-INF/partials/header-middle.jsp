		...
		<div class="row">
			...
			<div class="col-lg-3">
				<div class="logo pb-sm-30 pb-xs-30">
					<a href="<c:url value="home" />"> <img src="images/menu/logo/1.jpg" alt="">
					</a>
				</div>
			</div>
			...
			<div class="col-lg-9 pl-0 ml-sm-15 ml-xs-15">
				...
				<div class="header-middle-right">
					<ul class="hm-menu">
						...
						<li class="hm-wishlist"><a href="<c:url value="wishlist"/>"> <span
						...
						<li class="hm-minicart">
							...
							<div class="minicart">
								<ul class="minicart-product-list">
									<li><a href="<c:url value="single-product"/>"
										class="minicart-product-image"> <img
											src="images/product/small-size/5.jpg" alt="cart products">
									</a>
										<div class="minicart-product-details">
											<h6>
												<a href="<c:url value="single-product"/>">Aenean eu tristique</a>
											</h6>
											<span>£40 x 1</span>
										</div>
								...
								<div class="minicart-button">
									<a href="<c:url value="shoppingcart"/>"
										class="li-button li-button-fullwidth li-button-dark"> <span>View
											Full Cart</span>
									</a> <a href="<c:url value="checkout"/>" class="li-button li-button-fullwidth">
										<span>Checkout</span>
									</a>
								</div>
							</div>
