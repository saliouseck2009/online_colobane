								...
								<div
									...
									<div class="slider-content">
										...
										<div class="default-btn slide-btn">
											<a class="links" href="shop-left-sidebar.jsp">Shopping
												Now</a>
										</div>
									</div>
								</div>
									...
									<div class="single-product-wrap">
										...
										<div class="product_desc">
											<div class="product_desc_info">
												...
												<h4>
													<a class="product_name" href="single-product.jsp">Accusantium
														dolorem1</a>
												</h4>
												<div class="price-box">
											...
											<div class="add-actions">
												<ul class="add-actions-link">
													<li class="add-cart active"><a href="#">Add to
															cart</a></li>
													<li><a class="links-details" href="wishlist.jsp"><i
									...
									<div class="single-product-wrap">
										...
										<div class="product_desc">
											<div class="product_desc_info">
												...
												<h4>
													<a class="product_name" href="single-product.jsp">Mug
					...
					<div class="col-lg-12">
						<div class="li-section-title">
							...
							<ul class="li-sub-category-list">
								<li class="active"><a href="shop-left-sidebar.jsp">Prime
										Video</a></li>
								<li><a href="shop-left-sidebar.jsp">Computers</a></li>
								<li><a href="shop-left-sidebar.jsp">Electronics</a></li>
							</ul>
						</div>
						<div class="row">
							<div class="product-active owl-carousel">
				...
				<div class="row">
					...
					<div class="col-lg-12">
						<div class="li-section-title">
							...
							<ul class="li-sub-category-list">
								<li class="active"><a href="shop-left-sidebar.jsp">Chamcham</a></li>
								<li><a href="shop-left-sidebar.jsp">Sanai</a></li>
								<li><a href="shop-left-sidebar.jsp">Meito</a></li>
							</ul>
						</div>
						<div class="row">
							<div class="product-active owl-carousel">
					...
					<div class="col-lg-12">
						...
						<div class="li-static-home-content">
							...
							<div class="default-btn">
								<a href="shop-left-sidebar.jsp" class="links">Shopping Now</a>
							</div>
						</div>
